...
Present the full plan as a structured document in the conversation. Write it like a colleague explaining to another engineer — plain English first, code second. Show, don't just list.
...
**Testing:**
- Test your logic, not framework guarantees
- Skip: dataclass construction, Pydantic validation, boto3/Django behaviour
- Focus: error handling, edge cases, data transformations, validation logic
- 5–10 focused tests > 20 generic ones
